...
public class D15HandlingDropdownList {
	...
	public static void main(String[] args) {
		...
		//Use this object to perform any action on this drop down list
		...
		//countries.selectByVisibleText("Greenland");
		//countries.selectByContainsVisibleText("Green");
		//countries.selectByValue("86");
		countries.selectByIndex(84);
		System.out.println("Selected Country: " + countries.getFirstSelectedOption().getText());
	}
